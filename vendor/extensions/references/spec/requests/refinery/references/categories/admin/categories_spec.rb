...
describe Refinery do
  describe "References::Categories" do
    describe "Admin" do
      describe "categories" do
        ...
        describe "categories list" do
          ...
          it "shows two items" do
            visit refinery.references_admin_categories_path
        ...
        describe "create" do
          ...
          context "valid data" do
            it "should succeed" do
              ...
              Refinery::References::Category.count.should == 1
            end
          end
          ...
          context "invalid data" do
            it "should fail" do
              ...
              Refinery::References::Category.count.should == 0
            end
          end
